...
pamk.best <- pamk(regions_2016.dist) # Compute pam to estimate the number of clusters
numberCluster <- pamk.best$nc
groups <- cutree(regions_2016.hclust, k=numberCluster) # cut tree into k clusters
# draw dendogram with red borders around the 5 clusters
rect.hclust(regions_2016.hclust, k=numberCluster, border="red") 
